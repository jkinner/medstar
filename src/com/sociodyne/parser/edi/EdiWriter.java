...
public class EdiWriter implements EdiHandler {
	...
	private EdiLocation location = new EdiLocation("ISA", 0);
	private boolean wroteSubElementSeparator = false;
	...
	public void startElement(String contents) throws EdiException {
		...
		if (! wroteSubElementSeparator
				&& location.getSegment().equals("ISA") && location.getIndex() == 16) {
			// Ignore whatever contents were provided; emit the sub-element separator instead.
