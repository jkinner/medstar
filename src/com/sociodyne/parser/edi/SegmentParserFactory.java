...
/**
 * A factory for {@link SegmentParser SegmentParsers}. It may create different implementations
 * for different segment identifiers, based on the requirements of the segment type.
 * 
...
public class SegmentParserFactory {
	...
	private final Map<String, Set<String>> loopNonTerminalSegments =
		ImmutableMap.<String, Set<String>>builder()
			.put("EB", ImmutableSet.of("DTP", "AAA", "MSG", "LS", "REF"))
			.put("NM1", ImmutableSet.of("HL", "EB", "EQ", "REF", "N3", "N4", "PER", "DMG", "INS",
				"DTP"))
			.put("EQ", ImmutableSet.of("DTP"))
			.build();
	...
	public SegmentParser create(Tokenizer tokenizer, EdiLocation location, EdiHandler handler,
		...
		if (segmentIdentifier.equals("HL")) {
			...
			Set<String> nonTerminalSegments = loopNonTerminalSegments.get(segmentIdentifier);
