...
/**
 * Guice module to bind the implementations of the handlers for the upload
 * servlet.
 * 
 * @author jkinner
 */
public class UploadModule extends ServletModule {
  ...
  protected void configureServlets() {
    ...
    final MapBinder<String, UploadHandler> handlerBindings = MapBinder.newMapBinder(binder(),
        String.class, UploadHandler.class);
